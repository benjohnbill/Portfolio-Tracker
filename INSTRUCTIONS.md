...
Double-click `run_server.bat` or run the following command in the terminal:
...
- If the server is **Running**, the app will use **Real Data** (1-Year History).
- If the server is **OFF**, the app will gracefully fall back to **Mock Data**.
